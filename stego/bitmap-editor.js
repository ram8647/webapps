/*
 * bitmap-editor.js -- script for bitmap editor widget.
 *
 ...
 *  bmpdecoder.html.  
 *
 *  The bitmap-editor lets the user alter the data 
 *  block of a bitmap image, inserting a 3-letter string in to the
 *  first 24 bytes of the image.  
 *
 *  The altered image can be downloaded and saved.  It can be decoded
 *  by the related app, bmpdecoder.html. 
 */
var base64bytes;
var rawData;
var rawUrl;
