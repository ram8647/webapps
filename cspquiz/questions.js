var quiz_data = [
        ...
        "choices": [
            {
                ...
                "score": 1.0,
                "text": "<img src=\"https://course.mobilecsp.org/mobilecsp/assets/img/Q17A1.PNG\" class=\"yui-img\" title=\"\" alt=\"\" style=\"line-height: 1.22;\">"
            },
            {
                ...
                "score": 0.0,
                "text": "<img src=\"https://course.mobilecsp.org/mobilecsp/assets/img/Q17A2.PNG\" class=\"yui-img\" title=\"\" alt=\"\"><br>"
            },
            {
                "feedback": "Not quite. Try that again! There are two loops in this algorithm.  In the inner loop the robot forward <i>n</i> times.  And in the other loop the value of <i>n</i> is decreased by one each time. So the robot will move forward 3 times then turn left, then move forward 2 times and turn left, then move forward 1 time.",
                "score": 0.0,
                "text": "<img src=\"https://course.mobilecsp.org/mobilecsp/assets/img/Q17A3.PNG\" class=\"yui-img\" title=\"\" alt=\"\"><br>"
            },
            {
                "feedback": "Not quite.  Try that again!. There are two loops in this algorithm.  In the inner loop the robot forward <i>n</i> times.  And in the other loop the value of <i>n</i> is decreased by one each time. So the robot will move forward 3 times then turn left, then move forward 2 times and turn left, then move forward 1 time.",
                "score": 0.0,
                "text": "<img src=\"https://course.mobilecsp.org/mobilecsp/assets/img/Q17A4.PNG\" class=\"yui-img\" title=\"\" alt=\"\"><br>"
            }
        ],
        "description": "AP CS P Exam Prep Move Robot Loop",
        "cspcode": "4.1.1D",
        "question": "The following question uses a robot in a grid of squares. The robot is represented as a triangle, which is initially in the bottom left square of the grid and facing right.<br><br><div style=\"text-align: left;\"><img src=\"https://course.mobilecsp.org/mobilecsp/assets/img/Q17SquareQuestion.PNG\" class=\"yui-img selected\" title=\"\" alt=\"\" style=\"line-height: 1.22;\"><span style=\"line-height: 1.22;\">&nbsp; &nbsp;<br><br></span></div>Consider the following code segment, which moves the robot in the grid.\n\n<br><br><div style=\"text-align: left;\"><img src=\"https://course.mobilecsp.org/mobilecsp/assets/img/Q17Code.PNG\" class=\"yui-img\" title=\"\" alt=\"\" style=\"line-height: 1.22;\"><br><br></div>Which of the following shows the location of the robot after running the code segment?\n",
        "heading": "College Board Sample Question: Algorithms",
  ...
  { 'choices': [ { 'feedback': 'A is not correct. When you arrange items or objects you are <i>sorting</i> through them. Therefore, a search algorithm is not appropriate for this problem.',
                 ...
                 { 'feedback': 'No, E is not correct. A binary search is only appropriate when the collection you are searching is arranged <i>in order </i>.',
                   'score': -1.0,
                   'text': 'E. Finding the smallest number in a list of numbers arranged randomly. '}],
    'cspcode': '4.2.4H',
...
{ 'choices': [ { 'feedback': 'No, a cryptographer is a person who makes up secret codes.',
  ...
  { 'cspcode': '6.3.1I',
   ...
   "heading":"College Board Sample Question: Copyright"
    ...
    { 'choices': [ { 'feedback': '',
                   'score': 0.0,
                   'text': '&nbsp;<br><div style="text-align: left;" class="yui-wk-div"><img src="https://course.mobilecsp.org/mobilecsp/assets/img/Q18A1.PNG" class="yui-img selected" title="" alt="" style="line-height: 1.22;"></div>'},
                 { 'feedback': 'No, this one is close! But it needs more turn right commands after the second move forward blocks.',
                   'score': 0.0,
                   'text': '&nbsp;<br><img src="https://course.mobilecsp.org/mobilecsp/assets/img/Q18A2.PNG" class="yui-img selected" title="" alt=""><br>'},
                 { 'feedback': '',
                   'score': 1.0,
                   'text': '<br><img src="https://course.mobilecsp.org/mobilecsp/assets/img/Q18A3.PNG" class="yui-img selected" title="" alt=""><br>'},
                 { 'feedback': '',
                   'score': 0.0,
                   'text': '<br><img src="https://course.mobilecsp.org/mobilecsp/assets/img/Q18A4.PNG" class="yui-img selected" title="" alt=""><br>'}],
    'cspcode': '5.3.1',
    ...
    'question': 'The figure below shows a robot in a grid of squares. The robot is represented as a triangle, which is initially facing upward. The robot can move into a white or gray square but cannot move into a black region.<br><br><div style="text-align: center;" class="yui-wk-div"><img src="https://course.mobilecsp.org/mobilecsp/assets/img/Q18SquareQuestion.PNG" class="yui-img" title="" alt="" style="line-height: 1.22;"><span style="line-height: 1.22;">&nbsp; &nbsp;<br><br></span></div>Consider the procedure <i>MoveAndTurn</i> below.<br><br><div style="text-align: center;" class="yui-wk-div"><img src="https://course.mobilecsp.org/mobilecsp/assets/img/Q18Code.PNG" class="yui-img" title="" alt="" style="line-height: 1.22;"><br><br></div>Which of the following code segments will move the robot to the gray square?',
    'source': 'cb-x',
    'type': "Mc",
    'wrongfeedback': ''},
    ...
    'wrongfeedback': ''},
         { 'choices': [ { 'feedback': 'No, the robot can get to the gray square following the code above.',
                   'score': 0.0,
                   'text': '&nbsp;<img src="https://course.mobilecsp.org/mobilecsp/assets/img/APExamPrepQ14ChoiceA.PNG" class="yui-img selected" title="" alt="" align="center" style="display: block;">'},
                 { 'feedback': 'No, the robot can get to the gray square following the code above.',
                   'score': 0.0,
                   'text': '<img src="https://course.mobilecsp.org/mobilecsp/assets/img/APExamPrepQ14ChoiceB.PNG" class="yui-img selected" title="" alt="" align="center" style="display: block;">'},
                 { 'feedback': 'No, the robot can get to the gray square following the code above.',
                   'score': 0.0,
                   'text': '&nbsp;<img src="https://course.mobilecsp.org/mobilecsp/assets/img/APExamPrepQ14ChoiceC.PNG" class="yui-img" align="center" style="display: block;" title="" alt="">'},
                 { 'feedback': 'Correct! The robot will not reach the gray square here because it will get stuck in the top right corner. It cannot turn from there because it cannot move left or right from there.',
                   'score': 1.0,
                   'text': '&nbsp;<img src="https://course.mobilecsp.org/mobilecsp/assets/img/APExamPrepQ14ChoiceD.PNG" class="yui-img" align="center" style="display: block;" title="" alt="">'}],
    'cspcode': '4.2.4B',
    ...
    'wrongfeedback': ''},
        { 'choices': [ { 'feedback': "Not quite - According to the table, backing up data for a company with 100,000 would take over 2,000 hours (200 x 10). Even though that's a long time, there is another task that would take even longer.",
                 ...
                 { 'feedback': 'That is correct!',
                   ...
                   'text': 'Sorting data'}],
    'cspcode': '3.2.2',
    'description': 'AP CS P EXAM PREP Internet Communication -- replaced <img src="https://course.mobilecsp.org/mobilecsp/assets/img/SampleExamQuestion10EfficiencyAlgorithms.PNG" class="yui-img" width="100%" style="max-width:600px">',
  ...
  { 'choices': [ { 'feedback': 'This is correct! If and only if A is true, the OR gate will output true causing the AND gate to have 2 true inputs, which would make it true.',
    ...
    'question': 'The figure shown here shows a circuit composed of two logic gates. The output of the circuit is <b>true</b>. Which of the following is a true statement about input A?<br><img src="https://course.mobilecsp.org/mobilecsp/assets/img/SampleExamQuestion6revLogicGates.PNG" class="yui-img"><br>',
    'source': 'cb-x',
    'type': 'Mc',
    'wrongfeedback': ''},
  { 'choices': [ { 'feedback': 'Sorry. The value 0 would be displayed if the loop was skipped entirely. But the loop will be entered and will iterate (repeat) until <i>i=4</i>.',
    ...
    'question': 'Consider the following program code. Which answer best describes the result of running the program code?<br><img src="https://course.mobilecsp.org/mobilecsp/assets/img/Q20Code.PNG" title="" alt="">',
    'source': 'cb-x',
    'type': 'Mc',
    'wrongfeedback': ''},
